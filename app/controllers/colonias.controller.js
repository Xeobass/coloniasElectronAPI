...
exports.create = (req, res) => {
  ...
  const colonias  = new Colonias({
    idColonia : req.body.id_colonia,
    nombreColonia : req.body.nombre_colonia,
    idProte : req.body.tb_id_protes
  });
...
exports.getAllColonias = (req,res)=>{
  Colonias.getAllColonias((err,data)=>{
    if(err)
      res.status(500).send({message:err.message || "Error al obtener los datos de los etados de las colonias."});
    else
      res.send(data);
